...
We encourage you to browse the existing GO-FIC code to find examples
...
All documentation in GO-FIC is done through in-line `godoc`. Please make
...
Once you have your code written, submit a Pull Request to GO-FIC and
