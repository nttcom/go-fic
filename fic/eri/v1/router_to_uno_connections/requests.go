...
// SourceRouteFilter represents RouteFilter parameters
// for Source RouteFilter of Connection.
type SourceRouteFilter struct {
	In  string `json:"in" required:"true"`
	Out string `json:"out" required:"true"`
}

// DestinationRouteFilter represents RouteFilter parameters
// for Destination RouteFilter of Connection.
type DestinationRouteFilter struct {
	Out string `json:"out" required:"true"`
}
...
type Destination struct {
	...
	VPNNumber            string                 `json:"vpnNumber" required:"true"`
	ParentContractNumber string                 `json:"parentContractNumber" required:"true"`
	ContractNumber       interface{}            `json:"contractNumber,omitempty"`
	CNumber              string                 `json:"cNumber,omitempty"`
	QosType              string                 `json:"qosType" required:"true"`
	RouteFilter          DestinationRouteFilter `json:"routeFilter" required:"true"`
}
...
type Source struct {
	...
	RouteFilter SourceRouteFilter `json:"routeFilter" required:"true"`
}
...
type CreateOpts struct {
	...
	ConnectedNetworkAddress string      `json:"connectedNwAddress"`
}
...
// SourceForUpdate represents Source of Connection in case of Updating.
type SourceForUpdate struct {
	RouteFilter SourceRouteFilter `json:"routeFilter" required:"true"`
}

// DestinationForUpdate represents Destination of Connection in case of Updating.
