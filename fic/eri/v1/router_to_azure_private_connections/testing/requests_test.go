...
func TestListConnections(t *testing.T) {
	...
	th.Mux.HandleFunc("/router-to-azure-private-connections",
...
func TestListConnectionAllPages(t *testing.T) {
	...
	th.Mux.HandleFunc("/router-to-azure-private-connections", func(w http.ResponseWriter, r *http.Request) {
		th.TestMethod(t, r, "GET")
...
func TestGetConnection(t *testing.T) {
	...
	url := fmt.Sprintf("/router-to-azure-private-connections/%s", idConnection1)
