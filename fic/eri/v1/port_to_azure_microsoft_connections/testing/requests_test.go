...
func TestListConnections(t *testing.T) {
	...
	th.Mux.HandleFunc("/port-to-azure-microsoft-connections",
...
func TestListConnectionAllPages(t *testing.T) {
	...
	th.Mux.HandleFunc("/port-to-azure-microsoft-connections", func(w http.ResponseWriter, r *http.Request) {
		th.TestMethod(t, r, "GET")
...
func TestGetConnection(t *testing.T) {
	...
	url := fmt.Sprintf("/port-to-azure-microsoft-connections/%s", idConnection1)
