...
func TestListConnections(t *testing.T) {
	...
	th.Mux.HandleFunc("/port-to-port-connections",
...
func TestListConnectionAllPages(t *testing.T) {
	...
	th.Mux.HandleFunc("/port-to-port-connections", func(w http.ResponseWriter, r *http.Request) {
		th.TestMethod(t, r, "GET")
...
func TestGetConnection(t *testing.T) {
	...
	url := fmt.Sprintf("/port-to-port-connections/%s", idConnection1)
