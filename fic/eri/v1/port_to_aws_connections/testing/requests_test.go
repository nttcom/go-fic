...
func TestListConnections(t *testing.T) {
	...
	th.Mux.HandleFunc("/port-to-aws-connections",
...
func TestListConnectionAllPages(t *testing.T) {
	...
	th.Mux.HandleFunc("/port-to-aws-connections", func(w http.ResponseWriter, r *http.Request) {
		th.TestMethod(t, r, "GET")
...
func TestGetConnection(t *testing.T) {
	...
	url := fmt.Sprintf("/port-to-aws-connections/%s", idConnection1)
