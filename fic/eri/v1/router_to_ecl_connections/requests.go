...
type Destination struct {
	...
	ECLTenantID     string `json:"eclTenantId" required:"true"`
	ECLAPIKey       string `json:"eclApiKey" required:"true"`
	ECLAPISecretKey string `json:"eclApiSecretKey" required:"true"`
}
